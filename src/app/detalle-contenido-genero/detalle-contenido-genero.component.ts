...
@Component({
  selector: 'app-detalle-contenido-genero',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './detalle-contenido-genero.component.html',
  styleUrl: './detalle-contenido-genero.component.css'
})
export class DetalleContenidoGeneroComponent implements OnInit, OnDestroy{
  ...
  ngOnInit() {
    const storedData = this.storageService.getItem('dataContenidoEspecifico');
